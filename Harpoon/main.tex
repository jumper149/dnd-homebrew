...
When removing a stuck item you make a Wisdom (Medicine) check (DC 10).
If you fail the check, you deal the pullout-damage to the target.
Regardless of the check you are able to remove the item.
