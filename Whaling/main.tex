...
\chapter{Whaling}
\DndDropCapLine{W}{haling is more than just a job.}
...
\DndItemHeader{Living Harpoon}{Magic Weapon, uncommon}
The living Harpoon inherits all regular stats from the Harpoon, but gets one more property.

\subparagraph{Special (Living Harpoon: Touch)}
...
\DndItemHeader{Speargun}{Ranged Weapon}
A device, to shoot a harpoon-like arrow, is often used to hunt fish.
...
\DndItemHeader{Harpoon Cannon}{Stationary Ranged Weapon}
...
\subparagraph{Special (Harpoon Cannon: Explosive Harpoon)}
The Harpoon Cannon can be loaded with an explosive head on the harpoon, which carries 1 lbs of gunpowder.
This changes the initial damage from 1d12 piercing to 2d20 fire damage.
...
\begin{DndMonster}[float]{Sperm Whale}
  % Sources:
...
\begin{DndMonster}[float]{Beluga Whale}
...
\begin{DndMonster}[float]{Giant Squid}
  \DndMonsterType{Gargantuan beast, unaligned}
...
\begin{DndMonster}[float]{Galápagos tortoise}
  ...
  % Traits
  \DndMonsterAction{Tough}
  The tortoise can survive for a whole year without food or water.

  \DndMonsterAction{Delicious}
  Tortoise meat is one of the most tasty foods.
